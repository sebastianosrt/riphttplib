...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    let headers = vec![Header::new("trailers".into(), "trailer".into()), Header::new("accept".into(), "text/htmln\ta:a".into()), Header::new_valueless("valueless".into())];
    let body = "test";
    let trailers = vec![Header::new("trailer".into(), "testa".into()), Header::new_valueless("sagetdasd\r\na".into())];

    let request = Request::new("https://localhost:23444", "GET")?
